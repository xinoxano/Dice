...
#import "HNEYACYAMLUnarchivingObject.h"
...
@implementation HNEYACYAMLUnarchivingObject {
    __unsafe_unretained HNEYACYAMLKeyedUnarchiver *_unarchiver;
...
{
    HNEYACYAMLUnarchivingObject *keyAndData[2];
    NSUInteger index = 0;
    ...
    if(type == YAML_MAPPING_START_EVENT) {
        ...
        id<HNEYACYAMLUnarchivingMapping> mappingElements;
        ...
        HNEYACYAMLUnarchivingObject *nextEventObject = nil;
        while((nextEventObject = [[HNEYACYAMLUnarchivingObject alloc] initWithParser:parser 
        ...
        id<HNEYACYAMLUnarchivingSequence> sequenceElements;
