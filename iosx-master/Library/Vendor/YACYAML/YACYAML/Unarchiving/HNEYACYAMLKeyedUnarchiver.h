...
@interface HNEYACYAMLKeyedUnarchiver : NSCoder
...
@protocol HNEYACYAMLUnarchivingSequence
...
@protocol HNEYACYAMLUnarchivingMapping
...
@protocol HNEYACYAMLUnarchivingScalar
