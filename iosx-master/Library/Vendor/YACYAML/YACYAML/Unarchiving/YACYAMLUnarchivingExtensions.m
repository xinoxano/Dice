...
@interface HNEYACYAMLMergeKey : NSObject
@end

static HNEYACYAMLMergeKey *sSharedYACYAMLMergeKey;
...
{
    [HNEYACYAMLKeyedUnarchiver registerUnarchivingClass:[NSArray class]];
    [HNEYACYAMLKeyedUnarchiver registerUnarchivingClass:[NSDictionary class]];
    [HNEYACYAMLKeyedUnarchiver registerUnarchivingClass:[NSNumber class]];
    [HNEYACYAMLKeyedUnarchiver registerUnarchivingClass:[NSData class]];
    [HNEYACYAMLKeyedUnarchiver registerUnarchivingClass:[NSSet class]];
    [HNEYACYAMLKeyedUnarchiver registerUnarchivingClass:[NSNull class]];
    [HNEYACYAMLKeyedUnarchiver registerUnarchivingClass:[NSDate class]];
    [HNEYACYAMLKeyedUnarchiver registerUnarchivingClass:[HNEYACYAMLMergeKey class]];
}
...
@implementation HNEYACYAMLMergeKey

+ (void)initialize
{
    if(self == [HNEYACYAMLMergeKey class]) {
