...
@interface HNEYACYAMLKeyedArchiver (testing)
...
- (void)testFloatScalarArchiving
{
    ...
    NSData *data = [HNEYACYAMLKeyedArchiver archivedDataWithRootObject:testArray];
    
    STAssertTrue(data.length != 0, nil);
    
    NSArray *unarchivedArray = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithData:data];
...
- (void)testDataArchiving
{
    ...
    NSData *data = [HNEYACYAMLKeyedArchiver archivedDataWithRootObject:testDictionary];
    
    STAssertTrue(data.length != 0, nil);
    
    NSArray *unarchivedDictionary = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithData:data];
...
- (void)testSetArchiving
{
    ...
    NSData *data = [HNEYACYAMLKeyedArchiver archivedDataWithRootObject:testSet];
...
- (void)testSimpleDictionaryArchiving
{
    ...
    NSDictionary *unarchivedDictionary = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithData:data];
...
- (void)testChars
{
    ...
    HNEYACYAMLKeyedArchiver *archiver = [[HNEYACYAMLKeyedArchiver alloc] initForWritingWithMutableData:data];
    ...
    HNEYACYAMLKeyedUnarchiver *unarchiver = [[HNEYACYAMLKeyedUnarchiver alloc] initForReadingWithData:data];
...
- (void)testUIButton
{
    ...
    NSData *data = [HNEYACYAMLKeyedArchiver archivedDataWithRootObject:button];
    
    STAssertTrue(data.length != 0, nil);
    
    UIView *unarchivedView = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithData:data];
    
    STAssertTrue([[HNEYACYAMLKeyedArchiver archivedDataWithRootObject:unarchivedView] isEqualToData:data], nil);
}

- (void)testAnchorGeneration
{
    HNEYACYAMLKeyedArchiver *archiver = [[HNEYACYAMLKeyedArchiver alloc] initForWritingWithMutableData:nil];
...
- (void)testPositiveIntegerParsing
{
    ...
    NSArray *unarchivedDictionary = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithString:integersYAML];
...
- (void)testNegativeIntegerParsing
{
    ...
    NSDictionary *unarchivedDictionary = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithString:integersYAML];
...
- (void)testPositiveFloatParsing
{
    ...
    NSDictionary *unarchivedDictionary = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithString:floatsYAML];
...
- (void)testBinaryParsing
{
    ...
    NSDictionary *unarchivedDictionary = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithString:binaryYAML];
...
- (void)testNullParsing
{
    ...
    NSDictionary *unarchivedDictionary = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithString:yaml];
...
- (void)testDateArchiving
{
    ...
    NSString *string = [HNEYACYAMLKeyedArchiver archivedStringWithRootObject:testArray];
    
    STAssertTrue(string.length != 0, nil);
    
    NSArray *unarchivedArray = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithString:string];
...
- (void)testMergeParsing
{
    ...
    NSArray *unarchived = [HNEYACYAMLKeyedUnarchiver unarchiveObjectWithString:yaml];
